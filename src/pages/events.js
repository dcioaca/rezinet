...
const Events = () => {
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#">
                  ...
                  Social Events <span class="sr-only">(current)</span>
                </a>
              </li>
              <li class="nav-item">
 ...
 <div class="row">
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">There are no upcoming events in the next 12 months.</p>
        <a href="#" class="btn btn-primary">Request Meeting</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Requested Events</h5>
        <p class="card-text">You do not have any event requests pending.</p>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">There are no open polls at this time</p>
