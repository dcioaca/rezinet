  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">You may request a password change or password reset below</p>
        <a href="#" class="btn btn-primary">Password Reset</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Moving soon? You can close this account to stop activity.</p>
        <a href="#" class="btn btn-primary">Request account close</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">You can contact us by clicking the button below</p>
